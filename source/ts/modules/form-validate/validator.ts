import {getLimitationsRegEx, getMatrixLimitationsRegEx, getMailRegEx} from './regular-expression.ts';
import {matrixReplace} from './matrix.ts';
import {Message} from './render-message.ts';
